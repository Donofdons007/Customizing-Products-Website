        ...
        ?>
            ...
            <select name="size" class="form-select w-200 m-auto">
                ...
                <option >XL</option>
                    ...
                    <td>
                <input type="file" name="design" id="product_image1" class="form-control"  >  
                    </td>
                   ...
                   <?php 
                    ...
                    if(isset($_POST['update_cart'])){
                        ...
                        $temp_image1=$_FILES['design']['tmp_name'];
                        
                        $size=$_POST['size'];
                        $update_cart="update `cart_details` set quantity=$quantities ,design='$design',size='$size' where ip_address='$get_ip_add' and product_id=$product_id";
